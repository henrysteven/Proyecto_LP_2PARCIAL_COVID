<html>
  ...
  <body>
    ...
    <?php
      ...
      exec("..\\R\\edadycovid.Rscript");
    ?>
    <h1 class = "graphtitle">Análisis de edades y contagio</h1>
    <p class = "graphtext">
    <img class = "graph" src=..\imagenes\edadycovid.png alt=”R Graph” height = 700 width = 700 />
